    ...
    struct DownloadSchema: ParsableCommand {
        ...
        func run() throws {
            ...
            let folderForDownloadedSchema = fileStructure.sourceRootURL
                .apollo.childFolderURL(folderName: "SwiftUIGithubApp")
            ...
            let header = ApolloSchemaDownloadConfiguration.HTTPHeader(key: "Authorization", value: "bearer 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")
